...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String SQL = "CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, email TEXT, phoneno TEXT, description TEXT)";
    ...
    public Contact getContact(String id) {
        ...
        Contact contacts = new Contact(ids,name,phoneno,email,description);
        db.close();
        return contacts;
    ...
    public void saveContact(Contact contacts) {
        ...
        cv.put("phoneno", contacts.phoneno);
        cv.put("description", contacts.description);
